...
12. Neuron OS: Мини-опреационная система от Neuron Ecosystem, в которой собраны все проекты и сервисы Neuron Ecosystem, все сделано плавно и с анимациями, также есть сохранение всех данных ОС в Firebase (т.е. облако) и мгновенная синхронизация между устройствами. Доступно на пк и телефонах. Ссылка: https://neuron-ecosystem.github.io/Neuron-OS/
